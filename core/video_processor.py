...
from core.detection_engine import DetectionEngine, Detection
from core.counter_logic import ObjectCounter, CountingEvent
...
# --- Heatmap imports ---
from utils.utils import HeatmapAccumulator  # add if you added the class in utils.py
...
class VideoWorker:
    ...
    def _initialize_video_writer(self):
        ...
        try:
            ...
            vw = cv2.VideoWriter(str(output_path), fourcc, fps, (width, height))
...
class VideoProcessor:
    ...
    def cleanup(self):
        ...
        try:
            ...
            try:
                from utils.results_export import get_master_log_writer
